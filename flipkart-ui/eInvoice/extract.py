...
import requests
import re
from symspellpy.symspellpy import SymSpell, Verbosity  #a spell check library
...
"""
text_file=open("Sample_Invoice_2/rawText.txt","r")
...
"""
csv_file=open("Sample_Invoice_2/keyValues.csv","r")
...
table1_exists=False
table2_exists=False
if(path.exists("Sample_Invoice_2/table-1.csv")):
	df_table1=pd.read_csv('Sample_Invoice_2/table-1.csv')
	table1_exists=True
	table1=open("Sample_Invoice_2/table-1.csv")
...
if(path.exists("Sample_Invoice_2/table-2.csv")):
	df_table2=pd.read_csv('Sample_Invoice_2/table-2.csv')
	table2_exists=True
	table2=open("Sample_Invoice_2/table-2.csv")
...
if(path.exists("Sample_Invoice_2/table-3.csv")):
	table3_exists=True
	df_table3=pd.read_csv('Sample_Invoice_2/table-3.csv')
	table3=open("Sample_Invoice_2/table-3.csv")
...
if(path.exists("Sample_Invoice_2/table-4.csv")):
	table4_exists=True
	table4=open("Sample_Invoice_2/table-4.csv","r")
	table4_lines=table4.readlines()
	df_table4=pd.read_csv('Sample_Invoice_2/table-4.csv')
...
if(path.exists("Sample_Invoice_2/table-5.csv")):
	table5_exists=True
	table5=open("Sample_Invoice_2/table-5.csv")
	table5_lines=table5.readlines()
	df_table5=pd.read_csv('Sample_Invoice_2/table-5.csv')
...
df=pd.read_csv('Sample_Invoice_2/keyValues.csv')
...
def wh_amount_txt(list_of_words,text_file_lines,text_file_total_txt,re):
	for i in text_file_lines:
		...
		#now this dictionary has keys of candidate values and values are a list of their locations
...
print(df_table1)
with open('Invoice_output1.csv', 'w', newline='') as file:
